...
if(WEBOS)
  ...
  # - webOS extension for more efficient strings. This is needed because the macros
  #   exported in node.h make use of it. 
  # - platform.h is needed because the string.h makes use of the DataBuffer class 
  #   used to wrap mmap-ed files.
  set(node_headers ${node_headers} src/node_string.h src/platform.h)

  # Other headers that the node addons use:
  install(FILES deps/libev/ev.h   DESTINATION ${NODE_INCLUDE_PREFIX}/include/node/libev)
  install(FILES deps/libeio/eio.h DESTINATION ${NODE_INCLUDE_PREFIX}/include/node/libeio)
endif()

install(FILES ${node_headers} DESTINATION ${NODE_INCLUDE_PREFIX}/include/node)

# webOS
if(CMAKE_SYSTEM_NAME MATCHES "CYGWIN")
  # Need node import library to build node addons
  install(FILES ${PROJECT_BINARY_DIR}/default/libnode.dll.a DESTINATION lib)
endif()
