...
# Hack for our cross-compile environment since it
# doesn't have rt and dl symlinks in the right location
# which prevents find_library() from finding it
if(WEBOS_DEVICE OR WEBOS_EMULATOR)
  set(RT rt)
  set(DL dl)
endif()
