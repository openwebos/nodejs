...
if(WEBOS)
  ...
  # XXX ASSERT(TARGET_CORE_OS == rockhopper && CMAKE_SYSTEM_PROCESSOR != arm => WEBOS_EMULATOR)
  ...
  elseif(CMAKE_SYSTEM_PROCESSOR STREQUAL "arm")
    ...
    set(WEBOS_EMULATOR 1)
  endif()

  add_definitions(-DWEBOS=1)
else()
  add_definitions(-DWEBOS=0)
endif()

# webOS
if(SHARED_V8)
  add_definitions(-DSHARED_V8=1)
else()
  add_definitions(-DSHARED_V8=0)
endif()
...
if(NOT in_source_build)
  file(COPY ${PROJECT_SOURCE_DIR}/tools/ DESTINATION ${PROJECT_BINARY_DIR}/tools FILES_MATCHING PATTERN "*" PATTERN ".*" EXCLUDE)
